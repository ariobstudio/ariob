...
namespace tasm {
namespace report {
static constexpr const uint32_t kAllFeaturesCount = 75;
...
enum LynxFeature : uint32_t {
  ...
  JAVA_HARDWARE_LAYER = 58,
  JAVA_NEW_SWIPER_NOT_ENABLED = 59,
  JAVA_LAYOUT_ANIMATION_CREATE_ANDROID = 60,
  JAVA_LAYOUT_ANIMATION_UPDATE_ANDROID = 61,
  JAVA_LAYOUT_ANIMATION_DELETE_ANDROID = 62,
  JAVA_ENTER_TRANSITION_NAME_ANDROID = 63,
  JAVA_EXIT_TRANSITION_NAME_ANDROID = 64,
  JAVA_PAUSE_TRANSITION_NAME_ANDROID = 65,
  JAVA_RESUME_TRANSITION_NAME_ANDROID = 66,
  JAVA_UPDATE_FONT_SCALE = 67,
  JAVA_DISABLE_REUSE_ANIMATION_STATE = 68,
  JAVA_DISABLE_FOLDVIEW_STOP_TOUCH_STOP_FLING = 69,
  JAVA_ASYNC_REDIRECT = 70,
  JAVA_ENABLE_ASYNC_REQUEST_IMAGE = 71,
  JAVA_SET_THEME_ANDROID = 72,
  JAVA_GET_THEME_ANDROID = 73,
  JAVA_ENABLE_ASYNC_LIST = 74,
};
