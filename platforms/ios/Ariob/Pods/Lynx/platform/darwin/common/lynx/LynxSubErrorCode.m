...
NSInteger const ECLynxBTSLifecycleListenerErrorException = 20301;
...
+ (LynxSubErrorCodeMetaData*)getMetaData:(NSInteger)subCode {
	switch (subCode) {
		...
		case ECLynxBTSLifecycleListenerErrorException:
			return [[LynxSubErrorCodeMetaData alloc] initWithLevel:ELynxLevelError fixSuggestion:@"Please see error info." consumer:@[]];
