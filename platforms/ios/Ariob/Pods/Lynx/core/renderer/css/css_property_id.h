...
#define FOREACH_ALL_PROPERTY(V)                                               \
  ...
  V(OffsetRotate, "offset-rotate", "")                                        \
  V(FontVariationSettings, "font-variation-settings", "normal")               \
  V(FontFeatureSettings, "font-feature-settings", "normal")                   \
  V(FontOpticalSizing, "font-optical-sizing", "none")
