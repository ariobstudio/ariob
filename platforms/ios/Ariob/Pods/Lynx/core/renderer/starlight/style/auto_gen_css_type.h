...
enum class BoxSizingType : uint8_t {
...
enum class WhiteSpaceType : uint8_t {
  kNormal = 0,  // version:1.0
  kNowrap = 1,  // version:1.0
};
enum class TextAlignType : uint8_t {
  kLeft = 0,     // version:1.0
...
enum class TextOverflowType : uint8_t {
  kClip = 0,      // version:1.0
...
enum class AlignContentType : uint8_t {
...
enum class JustifyContentType : uint8_t {
  kFlexStart = 0,     // version:1.0
  kCenter = 1,        // version:1.0
...
enum class FontStyleType : uint8_t {
  kNormal = 0,   // version:1.0
  kItalic = 1,   // version:1.0
  kOblique = 2,  // version:1.0
};
enum class LinearOrientationType : uint8_t {
...
enum class LinearGravityType : uint8_t {
  kNone = 0,              // version:1.0
  kTop = 1,               // version:1.0
...
enum class LinearLayoutGravityType : uint8_t {
  kNone = 0,              // version:1.0
  kTop = 1,               // version:1.0
  kBottom = 2,            // version:1.0
  kLeft = 3,              // version:1.0
...
enum class RelativeCenterType : uint8_t {
  kNone = 0,        // version:1.0
  kVertical = 1,    // version:1.0
  kHorizontal = 2,  // version:1.0
  kBoth = 3,        // version:1.0
};
enum class LinearCrossGravityType : uint8_t {
  kNone = 0,     // version:1.0
