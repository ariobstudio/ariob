...
<div id="settings" class="page hold center">
	...
	<div class=" screen gap hold">
		<details>
			<summary class="surface col center sap">Account</summary>
		...
		<details>
			<summary class="surface col center sap">Private Key</summary>
		...
		<details>
			<summary class="surface col center sap">Peer</summary>
			<p>In construction</p>
			</details>
			<details>
			...
			<details>
			<summary class="surface unit col center sap">Appearance</summary>
			<p>Only theme change, more customization to come!</p>
			<button id="theme"></button>
			</details>
		<details >
			<summary class="surface unit col center sap">About</summary>
			<p class="gap">
			<strong>Ariob</strong> is a decentralized social platform that aims to be the center for creativity and arts.
			</p>
