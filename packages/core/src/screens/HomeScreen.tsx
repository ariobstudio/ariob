import { Card, Button, Layout, ScrollableContent, Header } from '../components';
...
export function HomeScreen() {
  ...
  return (
    <Layout header={<Header title="Ariob" />}>
      <ScrollableContent>
        <view className="p-4" style={{ width: '100%', maxWidth: '600px', margin: '0 auto' }}>
          <Card className="mb-4 p-4" variant="elevated">
            <view className="mb-4">
              <text className="text-2xl py-2 font-semibold text-on-surface mb-2">
                Welcome to Ariob
              </text>
