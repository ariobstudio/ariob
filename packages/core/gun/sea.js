;(function(){
  ...
  ;USE(function(module){
    ...
    // if(!api.TextDecoder)
    // {
    //   const { TextEncoder, TextDecoder } = USE('./lib/text-encoding', 1);
  ...
  ;USE(function(module){
    ...
    SEA.pair = SEA.pair || (async (cb, opt) => { try {
      ...
      var sa = await NativeModules.NativeSEAModule.generateKey()
      .then(async (keys) => {
  ...
  ;USE(function(module){
    var u, Gun = (''+u != typeof GUN)? (GUN||{chain:{}}) : USE((''+u === typeof MODULE?'.':'')+'./gun.js');
  ...
  ;USE(function(module){
    ...
    var Gun = (SEA.window||'').GUN || USE((''+u === typeof MODULE?'.':'')+'./gun.js');
