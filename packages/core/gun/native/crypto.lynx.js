 ...
 * calls to a native crypto module. The polyfill supports cryptographic algorithms
 * commonly used by SEA.js and modern web applications.
 *
 * PLATFORM SUPPORT:
 * - LynxJS: Uses NativeModules.NativeWebCryptoModule
 * - Expo: Can use excrypto module or fallback to NativeWebCryptoModule
 * - Web/Node: Falls back to browser crypto.subtle if available
 *
 * ARCHITECTURE:
 ...
 * - Native Layer: Platform-specific module performing actual cryptographic operations
 *
 ...
 * 3. Pass base64 string across bridge to native
 * 4. Native performs cryptographic operation
 * 5. Native returns base64 result
 ...
 * - JavaScript strings use UTF-16, native uses UTF-8
...
// Platform detection: Support both Lynx and Expo environments
let native;
try {
  // Try @ariob/webcrypto module first (if available)
