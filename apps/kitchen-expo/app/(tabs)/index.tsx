...
export default function HomeScreen() {
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.stepContainer}>
        <ThemedText type="subtitle">🔐 Try the Crypto Demo</ThemedText>
        <ThemedText>
          Tap the <ThemedText type="defaultSemiBold">Crypto</ThemedText> tab to test native cryptography features:
        </ThemedText>
        <ThemedText>• SHA-256 hashing</ThemedText>
        <ThemedText>• AES-GCM encryption/decryption</ThemedText>
        <ThemedText>• Secure random number generation</ThemedText>
