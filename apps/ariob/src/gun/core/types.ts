export interface GunChain<T = any> {
    ...
    put: (data: Partial<T>, callback?: (ack: any) => void) => GunChain<T>;
  ...
  export interface GunUser extends GunChain<any> {
    create: (alias: string, passphrase: string, callback?: (ack: any) => void) => GunUser;
    auth: (alias: string, passphrase: string, callback?: (ack: any) => void) => GunUser;
    leave: () => void;
    delete: (alias: string, passphrase: string, callback?: (ack: any) => void) => void;
    recall: (options?: any, callback?: (ack: any) => void) => GunUser;
    is: WhoCredentials | null;
  }
